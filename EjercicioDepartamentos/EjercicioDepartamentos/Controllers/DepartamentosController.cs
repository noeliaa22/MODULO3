...
namespace EjercicioDepartamentos.Controllers
{
    public class DepartamentosController : Controller
    {
        ...
        {
            List<Departamento> departamento = await _context.Departamento.Include(x => x.Empresa).ToListAsync();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Abreviatura")] Departamento departamento)
        {
